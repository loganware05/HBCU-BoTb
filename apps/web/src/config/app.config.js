...
export const appConfig = {
    ...
    logoText: 'SP',
    description: 'B2B SaaS platform that tracks, measures, and optimizes how products appear in AI-generated shopping results through Generative Engine Optimization (GEO).',
    ...
    landing: {
        ...
        subheadline: 'Shop.py helps brands track, measure, and optimize how their products appear in AI-generated shopping results — before competitors do.',
